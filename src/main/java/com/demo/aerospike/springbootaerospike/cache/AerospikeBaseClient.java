...
public class AerospikeBaseClient {

	private static final Logger log = LoggerFactory.getLogger(AerospikeBaseClient.class);
	...
	public AerospikeBaseClient(ClientPolicy clientPolicy, Host[] hosts) {
		log.info("In constructor of AerospikeClient. Initializing with hosts: " + hosts);
